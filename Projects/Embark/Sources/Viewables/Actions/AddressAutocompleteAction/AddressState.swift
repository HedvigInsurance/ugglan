...
extension AddressSuggestion: Equatable {
    public static func == (lhs: GraphQL.AddressAutocompleteQuery.Data.AutoCompleteAddress, rhs: GraphQL.AddressAutocompleteQuery.Data.AutoCompleteAddress) -> Bool {
...
class AddressState {
    ...
    func confirm(_ suggestion: AddressSuggestion, withPreviousSuggestion previousSuggestion: AddressSuggestion?) -> Future<AddressSuggestion?> {
    ...
    func isComplete(suggestion: AddressSuggestion) -> Bool {
        return suggestion.id != nil &&
            suggestion.streetName != nil &&
            suggestion.streetNumber != nil &&
            suggestion.postalCode != nil &&
            suggestion.city != nil
    }
