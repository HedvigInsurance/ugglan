	...
	public static func makeActive() -> JSONObject {
		combineMultiple([
			...
			GraphQL.HomeInsuranceProvidersQuery
                .Data(insuranceProviders: [.init(id: "1", name: "Hedvig", switchable: true)]).jsonObject,
			makeCommonClaims(),
		])
	}
	...
	public static func makeActiveInFuture(switchable: Bool) -> JSONObject {
		combineMultiple([
			GraphQL.HomeQuery
				...
				.jsonObject,
			GraphQL.HomeInsuranceProvidersQuery
                .Data(insuranceProviders: [.init(id: "1", name: "Hedvig", switchable: switchable)]).jsonObject,
			makeCommonClaims(),
		])
	}
