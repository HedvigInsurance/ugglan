...
- Invite a friend and Upcoming payment post `.openDeepLink` (`DeepLink.forever` / `.upcomingPayment`) because they switch tabs, which `QuickActionsViewModel`'s modal flags cannot.
