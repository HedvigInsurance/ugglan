...
public struct DefaultStyling {
    ...
    public static func setNavigationBarAppearance() {
        ...
        //setting up appearance of scroll views inside navigation
        let items: [any UIAppearanceContainer.Type] = [
            hNavigationController.self, hNavigationControllerWithLargerNavBar.self,
        ]
        UINavigationBar.appearance(whenContainedInInstancesOf: items)
            .scrollEdgeAppearance =
            scrollEdgeNavigationBarAppearance()

        UINavigationBar.appearance(
            for: .init(userInterfaceStyle: .dark),
            whenContainedInInstancesOf: items
        )
        .standardAppearance =
            standardNavigationBarAppearance(style: .dark)
        UINavigationBar.appearance(
...
extension CGFloat {
    ...
    public static var cornerRadiusXXXL: CGFloat = 32
}
...
extension CGFloat {
    ...
    public static let padding19: CGFloat = 19
    public static let padding21: CGFloat = 21
    public static let padding24: CGFloat = 24
    public static let padding32: CGFloat = 32
    public static let padding40: CGFloat = 40
    public static let padding45: CGFloat = 45
