...
extension Presentation {
	public func withDismissButton<FutureValue>() -> some JourneyPresentation
	where P.Matter: UIViewController, P.Result: Future<FutureValue> {
	...
	public func withDismissButton<SignalValue>() -> some JourneyPresentation
	where P.Matter: UIViewController, P.Result: FiniteSignal<SignalValue> {
		withDismissButton { _ in
			ContinueJourney()
		}
	}
