...
public struct Squircle: Shape {
  ...
  public func path(in rect: CGRect) -> Path {
      Path { path in
          ...
          path.addCurve(to: CGPoint(x: rect.width - lineWidthOffset, y: normalisedRadius),
          ...
          path.addCurve(to: CGPoint(x: rect.width - normalisedRadius, y: rect.height - lineWidthOffset),
          ...
          path.addCurve(to: CGPoint(x: lineWidthOffset, y: rect.height - normalisedRadius),
          ...
          path.addCurve(to: CGPoint(x: normalisedRadius, y: lineWidthOffset),
