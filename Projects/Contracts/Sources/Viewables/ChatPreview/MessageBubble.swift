...
extension MessageBubble: Viewable {
    func materialize(events _: ViewableEvents) -> (UIView, Disposable) {
        ...
        let bodyStyle: TextStyle = messageType == .replied ? .brand(.body(color: .primary)) : .brand(.body(color: .tertiary))
        ...
        stylingView.backgroundColor = messageType == .replied ? .brand(.primaryButtonBackgroundColor) : .brand(.secondaryBackground())
