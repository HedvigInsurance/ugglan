...
extension JSONObject {
	public static func makeNorwegianHomeContentContract(status: GraphQL.ContractsQuery.Data.Contract.Status)
		-> JSONObject
	{
	...
	public static func makeNorwegianTravelContract(status: GraphQL.ContractsQuery.Data.Contract.Status)
		-> JSONObject
	{
		GraphQL.ContractsQuery.Data.Contract(
