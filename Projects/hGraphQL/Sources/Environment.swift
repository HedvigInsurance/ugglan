...
public enum Environment: Hashable {
    ...
    public static var hasOverridenDefault: Bool {
    ...
    public var endpointURL: URL {
        ...
        case .production:
            return URL(string: "https://giraffe.hedvig.com/graphql")!
        case let .custom(endpointUrl, _, _):
            return endpointUrl
        }
    }
    ...
    public var assetsEndpointURL: URL {
        switch self {
        case .staging:
            return URL(string: "https://graphql.dev.hedvigit.com")!
        case .production:
            return URL(string: "https://giraffe.hedvig.com")!
        case let .custom(_, _, assetsUrl):
            return assetsUrl
        }
    }
}
