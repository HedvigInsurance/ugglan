...
extension Either: Codable where Left: Codable, Right: Codable{
    public init(from decoder: Decoder) throws {
        ...
        if let left = try? container.decode(Left.self) {
            ...
            self = .right(right)
        } else { throw DecodingError.dataCorrupted(.init(codingPath: container.codingPath, debugDescription: "Could not decode either left or right", underlyingError: nil)) }
    }
