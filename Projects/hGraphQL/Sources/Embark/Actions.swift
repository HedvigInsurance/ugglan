...
public struct hNumberAction: Codable {
    ...
    init(data: GraphQL.EmbarkStoryQuery.Data.EmbarkStory.Passage.Action.AsEmbarkNumberAction.NumberActionDatum) {
        key = data.key
        label = data.label
    ...
    init?(data: GraphQL.EmbarkStoryQuery.Data.EmbarkStory.Passage.Action.AsEmbarkNumberActionSet.Datum.NumberAction.Datum?) {
    ...
    init(data: GraphQL.EmbarkStoryQuery.Data.EmbarkStory.Passage.Action.AsEmbarkMultiAction.MultiActionDatum.Component.AsEmbarkMultiActionNumberAction.NumberActionDatum) {
        key = data.key
        label = data.label
        placeholder = data.placeholder
        maxValue = nil
...
public struct hSelectAction: Codable {
    ...
    init(data: GraphQL.EmbarkStoryQuery.Data.EmbarkStory.Passage.Action.AsEmbarkSelectAction.SelectActionDatum) {
        options = data.options.map { .init(link: .init(name: $0.link.name, label: $0.link.label), keys: $0.keys, values: $0.values, api: .init(api: $0.api))}
    }
}
...
public struct hMultiAction: Codable {
    ...
    public var components: [MultiActionComponent]
    init(data: GraphQL.EmbarkStoryQuery.Data.EmbarkStory.Passage.Action.AsEmbarkMultiAction.MultiActionDatum) {
        key = data.key
...
public struct hDatePickerAction: Codable {
    public var key: String?
    init(data: GraphQL.EmbarkStoryQuery.Data.EmbarkStory.Passage.Action.AsEmbarkDatePickerAction) {
        key = data.storeKey
    }
}
...
public struct hSwitchAction: Codable {
    public let key: String
    public let label: String?
    init(data: GraphQL.EmbarkStoryQuery.Data.EmbarkStory.Passage.Action.AsEmbarkMultiAction.MultiActionDatum.Component.AsEmbarkSwitchAction.SwitchActionDatum) {
        key = data.key
        label = data.label
    }
}
...
public struct hDropDownAction: Codable {
    ...
    init(data: GraphQL.EmbarkStoryQuery.Data.EmbarkStory.Passage.Action.AsEmbarkMultiAction.MultiActionDatum.Component.AsEmbarkDropdownAction.DropDownActionDatum) {
        key = data.key
        label = data.label
...
public struct hTextAction: Codable {
    var key: String?
    init(data: GraphQL.EmbarkStoryQuery.Data.EmbarkStory.Passage.Action.AsEmbarkTextAction.TextActionDatum) {
        key = data.key
    }
    
    init?(data: GraphQL.EmbarkStoryQuery.Data.EmbarkStory.Passage.Action.AsEmbarkTextActionSet.TextActionSetDatum.TextAction.Datum?) {
        guard let data = data else { return nil }
        key = data.key
    }
}
...
public struct hEmbarkAction: Codable {
    ...
    init?(action: GraphQL.EmbarkStoryQuery.Data.EmbarkStory.Passage.Action?) {
...
extension ActionTypeName {
    enum CodingKeys: CodingKey {
            case multiAction, numberAction, textAction, datePickerAction, selectAction, textActionSet, numberActionSet
    }
