...
public struct SubmitClaimCheckoutNoRepairScreenOld: View {
...
struct SubmitClaimCheckoutNoRepairScreenOld_Previews: PreviewProvider {
    static var previews: some View {
        SubmitClaimCheckoutNoRepairScreenOld()
    }
}
