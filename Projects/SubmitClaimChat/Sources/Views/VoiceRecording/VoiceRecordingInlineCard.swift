...
/// Replaces the previous voice recording detent; same `VoiceRecorder` and control tiles.
struct VoiceRecordingInlineCard: View {
    ...
    private var subtitle: String {
        if voiceRecorder.isSending { return SubmitClaimAudioStepCopy.sending }
    ...
    private var waveformSection: some View {
        ...
        .accessibilityAddTraits(isPlaybackMode ? .startsMediaSession : [])
