...
let project = Project(
    ...
    targets: [
        Target(
            ...
            sources: ["Sources/**", ""],
            resources: ["Resources/**", "Config/Test/Resources/**", "Config/Test/PrivacyInfo.xcprivacy"],
        ...
        Target(
            ...
            sources: ["Sources/**"],
            resources: ["Resources/**", "Config/Production/Resources/**", "Config/Production/PrivacyInfo.xcprivacy"],
        ...
        Target(
            ...
            resources: ["Config/Test/PrivacyInfo.xcprivacy"],
        ...
        Target(
            ...
            infoPlist: "../../Projects/NotificationService/Info.plist",
            sources: "../NotificationService/**",
            resources: ["Config/Production/PrivacyInfo.xcprivacy"],
