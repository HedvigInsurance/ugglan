...
extension Contract {
    init(
        ...
        self.init(
            ...
            exposureDisplayNameShort: pendingContract.exposureDisplayNameShort,
    ...
    init(
        ...
        self.init(
            ...
            exposureDisplayNameShort: contract.exposureDisplayNameShort,
            ...
            supportsTermination: contract.supportsTermination,
