...
extension BubbleLoading: Presentable {
	func materialize() -> (LightContentViewController, Future<Void>) {
		...
		activityIndicator.snp.makeConstraints { make in make.height.equalToSuperview()
		...
		bubbleView.frame = CGRect(x: originatingPoint.x, y: originatingPoint.y, width: 0.1, height: 0.1)
