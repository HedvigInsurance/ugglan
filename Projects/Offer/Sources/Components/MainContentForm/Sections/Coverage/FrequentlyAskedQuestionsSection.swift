...
extension FrequentlyAskedQuestionsSection: Presentable {
	func materialize() -> (SectionView, Disposable) {
        ...
        let button = Button(title: L10n.offerFooterButtonText, type: .standardOutlineIcon(borderColor: .brand(.primaryText()), textColor: .brand(.primaryText()), icon: .left(image: hCoreUIAssets.chat.image, width: 24)))
        ...
        innerSection.dynamicStyle = .brandGrouped(separatorType: .standard,  backgroundColor: .white)
