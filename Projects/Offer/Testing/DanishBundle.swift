...
func generateDanishTravelRows() -> [GraphQL.QuoteBundleQuery.Data.QuoteBundle.PossibleVariation.Bundle.Quote.DetailsTable.Section.Row] {
    [
        .init(title: "Co-insured", subtitle: nil, value: "You + 2")
    ]
}

func generateDanishHomeRows() -> [GraphQL.QuoteBundleQuery.Data.QuoteBundle.PossibleVariation.Bundle.Quote.DetailsTable.Section.Row] {
    [
...
func generateDanishAccidentRows() -> [GraphQL.QuoteBundleQuery.Data.QuoteBundle.PossibleVariation.Bundle.Quote.DetailsTable.Section.Row] {
    [
        .init(title: "Co-insured", subtitle: nil, value: "You + 2")
    ]
}
    ...
    public static func makeDanishBundle() -> GraphQL.QuoteBundleQuery.Data {
        GraphQL.QuoteBundleQuery.Data(
            quoteBundle: .init(possibleVariations: [
                .init(id: "bla", tag: nil, bundle: .init(
                    quotes: [
                        .init(
                            id: "123",
                            firstName: "Hedvig",
