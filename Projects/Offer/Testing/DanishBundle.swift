...
func generateDanishTravelRows() -> [GraphQL.QuoteBundleQuery.Data.QuoteBundle.PossibleVariation.Bundle.Quote
    .DetailsTable.Section.Row]
{
    [
...
func generateDanishHomeRows() -> [GraphQL.QuoteBundleQuery.Data.QuoteBundle.PossibleVariation.Bundle.Quote.DetailsTable
    .Section.Row]
{
    [
...
func generateDanishAccidentRows() -> [GraphQL.QuoteBundleQuery.Data.QuoteBundle.PossibleVariation.Bundle.Quote
    .DetailsTable.Section.Row]
{
    [
        .init(title: "Co-insured", subtitle: nil, value: "You + 2")
