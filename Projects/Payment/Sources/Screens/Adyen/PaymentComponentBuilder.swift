...
class AdyenPaymentBuilder: PaymentComponentBuilder, APIContextAware {
    ...
    var formComponentStyle: FormComponentStyle {
        ...
        formComponent.mainButtonItem.button.backgroundColor = .brand(.secondaryBackground(true))
        formComponent.mainButtonItem.button.title.color = .brand(.primaryText())
        ...
        formComponent.textField.tintColor = .brand(.primaryText())
        formComponent.textField.errorColor = .brand(.alert)
