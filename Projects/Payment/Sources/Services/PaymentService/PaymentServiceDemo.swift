...
public class hPaymentServiceDemo: hPaymentService {
    ...
    public func getPaymentData() async throws -> PaymentData? {
        ...
        return .init(
            id: "",
            payment: .init(gross: .sek(460), net: .sek(400), carriedAdjustment: nil, settlementAdjustment: nil, date: "2023-11-30"),
            status: .upcoming,
            contracts: [
                .init(
                    id: "id",
        ...
        let success = PaymentHistoryListData(
            ...
            valuesPerMonth: [
                .init(
                    ...
                    paymentData: .init(
                        id: "idI1",
                        payment: .init(gross: .sek(20), net: .sek(18), carriedAdjustment: nil, settlementAdjustment: nil, date: "2023-11-11"),
                        status: .success,
                        contracts: [],
                        discounts: [],
                        paymentDetails: nil,
