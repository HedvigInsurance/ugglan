...
//  hCore
//
//  Created by Sam Pettersson on 2021-08-03.
...
public struct PresentableViewNavigationBarConfigurer: ViewModifier {
    ...
    public init(_ configurer: @escaping (_ navigationItem: UINavigationItem) -> Void) {
...
extension View {
    public func presentableTitle(_ title: String) -> some View {
        self.modifier(PresentableViewNavigationBarConfigurer({ navigationItem in
