...
public struct FeatureData: Codable, Equatable {
    ...
    public let isNewClaimFlowEnabled: Bool
    ...
    public init(
        ...
        self.isNewClaimFlowEnabled = isNewClaimFlowEnabled
    }
}
...
public class FeatureFlags: ObservableObject {
    ...
    @Published public private(set) var isNewClaimFlowEnabled = false
    ...
    public func setup(with context: [String: String]) async throws {
        ...
        featureDataCancellable = client.featureData
            ...
            .sink { [weak self] data in
                ...
                self.isNewClaimFlowEnabled = data.isNewClaimFlowEnabled
            }
        self.client = client
