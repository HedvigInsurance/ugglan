...
public struct FeatureData: Codable, Equatable {
    ...
    public let isManualChargeEnabled: Bool
    ...
    public init(
        ...
        self.isManualChargeEnabled = isManualChargeEnabled
    }
}
...
public class FeatureFlags: ObservableObject {
    ...
    @Published public private(set) var isManualChargeEnabled = false
    ...
    public func setup(with context: [String: String]) async throws {
        ...
        featureDataCancellable = client.featureData
            ...
            .sink { [weak self] data in
                ...
                self.isManualChargeEnabled = data.isManualChargeEnabled
            }
        self.client = client
