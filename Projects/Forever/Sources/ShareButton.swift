...
extension ShareButton: Viewable {
	func materialize(events _: ViewableEvents) -> (UIView, Signal<UIView>) {
		...
		separator.snp.makeConstraints { make in make.top.leading.trailing.equalToSuperview()
		...
		colorView.snp.makeConstraints { make in make.top.bottom.leading.trailing.equalToSuperview() }
