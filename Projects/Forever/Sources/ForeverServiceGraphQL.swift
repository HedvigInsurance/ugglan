...
public class ForeverServiceGraphQL: ForeverService {
	public func changeDiscountCode(_ value: String) -> Signal<Either<Void, ForeverChangeCodeError>> {
		client.perform(mutation: GraphQL.ForeverUpdateDiscountCodeMutation(code: value)).valueSignal.map {
			data in let updateReferralCampaignCode = data.updateReferralCampaignCode
