...
public extension Project {
    static func framework(
        ...
        targetDependencies.append(contentsOf: dependencies.map { .project(target: $0, path: .relativeToRoot("Dependencies/\($0)")) })
        ...
        if targets.contains(.example) {
            let exampleTarget = Target(
                ...
                settings: Settings(
                    base: ["PROVISIONING_PROFILE_SPECIFIER": "match Development com.hedvig.example.*"],
