...
let template = Template(
    ...
    files: [
        ...
        .string(path: "\(nameAttribute)/Example/Resources/Assets.xcassets/contents.json", contents: xcassetsContents),
        .string(path: "\(nameAttribute)/Example/Resources/Assets.xcassets/AppIcon.appiconset/contents.json", contents: xcassetsAppIconContents),
