...
extension ContractRow: Reusable {
    ...
    var daysUntilRenewal: Int? {
        ...
        guard let date = formatter.date(from: self.contract.upcomingRenewal?.renewalDate ?? "") else {
            return nil
        }
    ...
    func makeFormContent() -> (DisposeBag, [ThreeEither<SectionView, UIView, Spacing>]) {
        ...
        return (
            ...
            [
                ...
                self.contract.upcomingRenewal != nil ? renewalRowContent : nil,
                self.contract.upcomingRenewal != nil ? [.make(Spacing(height: 10))] : nil,
                infoRowContent,
                [.make(Spacing(height: 10))],
                coverageRowContent,
                [.make(Spacing(height: 10))],
