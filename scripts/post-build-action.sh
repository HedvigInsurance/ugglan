...
mv -iv -- "${CONFIGURATION_BUILD_DIR}/"Adyen3DS2.framework "${TARGET_BUILD_DIR}/${TARGET_NAME}.app/Frameworks/"Adyen3DS2.framework
mv -iv -- "${CONFIGURATION_BUILD_DIR}/"Shake.framework "${TARGET_BUILD_DIR}/${TARGET_NAME}.app/Frameworks/"Shake.framework
