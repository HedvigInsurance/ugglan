...
enum DirectDebitResultType {
    ...
    var headingText: String {
        switch self {
        case .success:
            return String.translation(.DIRECT_DEBIT_SUCCESS_HEADING)
        case .failure:
            return String.translation(.DIRECT_DEBIT_FAIL_HEADING)
        }
    }
    ...
    var messageText: String {
        switch self {
        case .success:
            return String.translation(.DIRECT_DEBIT_SUCCESS_MESSAGE)
        case .failure:
            return String.translation(.DIRECT_DEBIT_FAIL_MESSAGE)
        }
    }
    ...
    var buttonText: String {
        switch self {
        case .success:
            return String.translation(.DIRECT_DEBIT_SUCCESS_BUTTON)
        case .failure:
            return String.translation(.DIRECT_DEBIT_FAIL_BUTTON)
        }
    }
