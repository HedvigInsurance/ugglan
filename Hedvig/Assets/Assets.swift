...
internal enum Asset {
  ...
  internal static let charityWhiteCircle = ImageAsset(name: "CharityWhiteCircle")
  ...
  internal static let greenCircularCheckmark = ImageAsset(name: "GreenCircularCheckmark")
  ...
  internal static let wordmarkAnimation = DataAsset(name: "WordmarkAnimation")
